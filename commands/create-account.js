...
async function createAccount(options) {
    ...
    if (keyPair) {
        ...
        if(keyRootPath==undefined||keyRootPath=="undefined"){
        //    keyRootPath = "~/.near-credentials";
            keyRootPath = process.env.NEAR_CLI_LOCALNET_KEY_PATH_ROOT;
        }
